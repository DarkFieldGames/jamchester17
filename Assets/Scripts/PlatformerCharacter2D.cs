...
namespace UnityStandardAssets._2D
{
    public class PlatformerCharacter2D : MonoBehaviour
    {
		...
		[SerializeField] private float k_CeilingRadius = .01f; // Radius of the overlap circle to determine if the player can stand up
